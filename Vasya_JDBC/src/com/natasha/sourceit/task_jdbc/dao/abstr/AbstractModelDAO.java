...
public abstract class AbstractModelDAO<T extends BaseDbModel> {
    ...
    public List<T> getModelsByIds(List<Integer> ids) throws SQLException {
    ...
    protected String getWhereForEquals(String colName, int value) {
